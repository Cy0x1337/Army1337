...
╚═╝     ╚═╝╚═════╝╚═╝  ╚═╝╚═════╝ ╚═════╝╚═════╚═╝  ╚═╚═╝  ╚═══╝    ╚═╝  ╚═╚═╝  ╚═╚═╝     ╚═╝  ╚═╝   
  ...
  print(banner)
  print("{}[{}1{}] {} ☠️ Grab Website From Words".format(fr, fg, fr, fw))
  print("{}[{}2{}] {} ☠️ WordPress Grabber From Plugins Name".format(fr, fg, fr, fw))
  print("{}[{}3{}] {} ☠️ WordPress Grabber From Themes Name".format(fr, fg, fr, fw))
  print("{}[{}4{}] {} ☠️ Grab Website From Domain Extensions".format(fr, fg, fr, fw))
  print("{}[{}5{}] {} ☠️ Grab Website From Dates".format(fr, fg, fr, fw))
  print("{}[{}6{}] {} ☠️ Get IP From Domain".format(fr, fg, fr, fw))
  print("{}[{}7{}] {} ☠️ IP Ranger (1-255)".format(fr, fg, fr, fw))
  print("{}[{}8{}] {} ☠️ Reverse IP Unlimited".format(fr, fg, fr, fw))
  print("{}[{}9{}] {} ☠️ Subdomain Scanner".format(fr, fg, fr, fw))
  choice = str(input('\ [☠️===>]: '.format(fy, fr, fre)))
  if (choice == '1'):
